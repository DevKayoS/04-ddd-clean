...
describe('Delete an answer', ()=> {
  beforeEach(()=> {
    inMememoryAnswerAttachmentRepository = new  InMemoryAnswerAttachmentsRepository()
    inMemoryAnswerRepository = new  InMemoryAnswerRepository(inMememoryAnswerAttachmentRepository)
